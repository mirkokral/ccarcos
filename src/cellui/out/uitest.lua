...
Test.main = function() 
  ...
  local screen = ScrollContainer.new(_hx_tab_array({}, 0));
  local x = 0.0;
  local map = Test.candidates;
  local _g_map = map;
  local _g_keys = map:keys();
  while (_g_keys:hasNext()) do _hx_do_first_1 = false;
    ...
    local func = _g_value;
    local w = func();
    local origin = screen:getMostWidgetHeight();
    local l = Label.new(0, origin, Std.string("\n") .. Std.string(name));
    origin = origin + 2;
    w.y = origin;
    w.x = 0;
    w.width = 0;
...
local _hx_static_init = function()
  ...
  Test.candidates = (function() 
    ...
    local value = function() 
      local w = SimpleContainer.new(_hx_tab_array({}, 0));
      local i = 0;
      local _g = __haxe_ds_StringMap.new();
      local value = _hx_tab_array({[0]=0.0, 0.0, "4"}, 3);
      if (value == nil) then 
        _g.h.Left = __haxe_ds_StringMap.tnull;
      else
        _g.h.Left = value;
      end;
      local value = _hx_tab_array({[0]=1.0, 0.0, "9"}, 3);
      if (value == nil) then 
        _g.h.Right = __haxe_ds_StringMap.tnull;
      else
        _g.h.Right = value;
      end;
      local value = _hx_tab_array({[0]=0.5, 0.0, "b"}, 3);
      if (value == nil) then 
        _g.h.Center = __haxe_ds_StringMap.tnull;
      else
        _g.h.Center = value;
      end;
      local value = _hx_tab_array({[0]=0.0, 0.5, "2"}, 3);
      if (value == nil) then 
        _g.h["Left Middle"] = __haxe_ds_StringMap.tnull;
      else
        _g.h["Left Middle"] = value;
      end;
      local value = _hx_tab_array({[0]=1.0, 0.5, "5"}, 3);
      if (value == nil) then 
        _g.h["Right Middle"] = __haxe_ds_StringMap.tnull;
      else
        _g.h["Right Middle"] = value;
      end;
      local value = _hx_tab_array({[0]=0.5, 0.5, "8"}, 3);
      if (value == nil) then 
        _g.h.Middle = __haxe_ds_StringMap.tnull;
      else
        _g.h.Middle = value;
      end;
      local value = _hx_tab_array({[0]=0.0, 1.0, "e"}, 3);
      if (value == nil) then 
        _g.h["Left Down"] = __haxe_ds_StringMap.tnull;
      else
        _g.h["Left Down"] = value;
      end;
      local value = _hx_tab_array({[0]=1.0, 1.0, "7"}, 3);
      if (value == nil) then 
        _g.h["Right Down"] = __haxe_ds_StringMap.tnull;
      else
        _g.h["Right Down"] = value;
      end;
      local value = _hx_tab_array({[0]=0.5, 1.0, "a"}, 3);
      if (value == nil) then 
        _g.h["Center Down"] = __haxe_ds_StringMap.tnull;
      else
        _g.h["Center Down"] = value;
      end;
      local v = _g;
      local map = v;
      local _g_map = map;
    ...
    if (value == nil) then 
      _g.h.Alignment = __haxe_ds_StringMap.tnull;
    else
      _g.h.Alignment = value;
    end;
    
    local value = function() 
      local w = TextArea.new(0, 0, "Placeholder");
      w.height = 1;
      do return w end;
    end;
    if (value == nil) then 
      _g.h["Single-line text area"] = __haxe_ds_StringMap.tnull;
    else
      _g.h["Single-line text area"] = value;
    end;
    ...
    if (value == nil) then 
      _g.h["Multi-line text area"] = __haxe_ds_StringMap.tnull;
    else
      _g.h["Multi-line text area"] = value;
    end;
