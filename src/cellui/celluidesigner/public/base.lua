...
Transition.prototype.run = function(self,callback,min,max) 
  ...
  __haxe_Log.trace("asd2", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true,customParams=true},fileName="src/Button.hx",lineNumber=34,className="Transition",methodName="run",customParams=_hx_tab_array({[0]=Std.string(la)}, 1)}));
  local _g_min = 0;
  ...
  while (_g_min < _g_max) do _hx_do_first_1 = false;
    ...
    __haxe_Log.trace(Std.string(i * la), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/Button.hx",lineNumber=38,className="Transition",methodName="run"}));
...
Transition.prototype.runForScreens = function(self,callback,screenwidth,screenheight) 
  ...
  local cb = function(n) 
    ...
    if (_g) == "over" then 
      ...
      if (_g) == "bottom" then 
        callback(0, 0, 0, e - screenheight, false);
      elseif (_g) == "left" then 
        callback(0, 0, e - screenwidth, 0, false);
      elseif (_g) == "right" then 
        callback(0, 0, screenwidth - e, 0, false);
      elseif (_g) == "top" then 
        callback(0, 0, 0, screenheight - e, false); end;
    elseif (_g) == "slide" then 
      local _g = _gthis.direction;
      if (_g) == "bottom" then 
        callback(0, e, 0, e - screenheight, false);
      elseif (_g) == "left" then 
        callback(e, 0, e - screenwidth, 0, false);
      elseif (_g) == "right" then 
        callback(-e, 0, screenwidth - e, 0, false);
      elseif (_g) == "top" then 
        callback(0, -e, 0, screenheight - e, false); end;
    elseif (_g) == "under" then 
      local _g = _gthis.direction;
      if (_g) == "bottom" then 
        callback(0, e, 0, 0, true);
      elseif (_g) == "left" then 
        callback(e, 0, 0, 0, true);
      elseif (_g) == "right" then 
        callback(-e, 0, 0, 0, true);
      elseif (_g) == "top" then 
        callback(-e, 0, 0, 0, true); end; end;
  end;
...
Transition.prototype.getValue = function(self,ratio) 
  local _g = self.curve;
  if (_g) == "ease" then 
...
Command.prototype.execute = function(self,runner,screenwidth,screenheight) 
  ...
  if (_g) == "execLua" then 
    ...
    if (_hx_1_l_func == nil) then 
      __haxe_Log.trace(Std.string("Cannot load lua function because of ") .. Std.string(_hx_1_l_message), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/Button.hx",lineNumber=176,className="Command",methodName="execute"}));
    end;
    l.func();
  elseif (_g) == "goToScreen" then 
    ...
    local _g = 0;
    local _g1 = runner:getWman():current():getPRenderCommands(screenwidth, screenheight);
    ...
    local _g = 0;
    local _g1 = runner:getWman().screens[Std.parseInt(self.value)]:getPRenderCommands(screenwidth, screenheight);
    while (_g < _g1.length) do _hx_do_first_1 = false;
    ...
    self.transition:runForScreens(function(prevx,prevy,newx,newy,firstOnTop) 
    ...
    end, Std.int(screenwidth), Std.int(screenheight)); end;
end
...
Widget.prototype.getPRenderCommands = function(self,screenwidth,screenheight,respectPosition) 
  ...
  while (_g < _g1) do _hx_do_first_1 = false;
    ...
    while (_g < _g1) do _hx_do_first_2 = false;
      ...
      _g = _g + 1;
      local ix = _g - 1;
      rc:push(PositionedRenderCommand.new(i, ix, " ", self.style.fgColor, self.style.bgColor));
    end;
  end;
  local _g = 0;
  ...
  while (_g < rc.length) do _hx_do_first_1 = false;
    ...
    local command = rc[_g];
    _g = _g + 1;
    if ((command.x >= fwidth) or (command.y >= fheight)) then 
      break;
    end;
...
Widget.prototype.onClick = function(self,pos,mb,_self) 
end
Widget.prototype.onDrag = function(self,startpos,pos,mb,_self) 
end
Widget.prototype.onClickUp = function(self,startpos,pos,mb,_self) 
end
Widget.prototype.onScroll = function(self,pos,dir,_self) 
end
...
SimpleContainer.prototype.onClick = function(self,pos,mb,_self) 
  local _g = 0;
  local _g1 = self.children;
  while (_g < _g1.length) do _hx_do_first_1 = false;
    ...
    local widget = _g1[_g];
    _g = _g + 1;
    local xp = Vector2f.add(pos, self.offset):addInts(widget.x, widget.y);
    local wself = (((xp.x >= widget.x) and (xp.y >= widget.y)) and (xp.x <= (widget.x + widget.width))) and (xp.y <= (widget.x + widget.width));
    widget:onClick(xp, mb, wself);
    if (widget.requestsRerender) then 
      self:requestRerender();
    end;
  end;
end
SimpleContainer.prototype.onDrag = function(self,startpos,pos,mb,_self) 
  local _g = 0;
  local _g1 = self.children;
  while (_g < _g1.length) do _hx_do_first_1 = false;
    ...
    local widget = _g1[_g];
    _g = _g + 1;
    local xp2 = Vector2f.add(startpos, self.offset):addInts(widget.x, widget.y);
    local xp = Vector2f.add(pos, self.offset):addInts(widget.x, widget.y);
    local wself = (((xp.x >= widget.x) and (xp.y >= widget.y)) and (xp.x <= (widget.x + widget.width))) and (xp.y <= (widget.x + widget.width));
    widget:onDrag(xp2, xp, mb, wself);
    if (widget.requestsRerender) then 
      self:requestRerender();
    end;
  end;
end
SimpleContainer.prototype.onClickUp = function(self,startpos,pos,mb,_self) 
  local _g = 0;
  local _g1 = self.children;
  while (_g < _g1.length) do _hx_do_first_1 = false;
    ...
    local xp = Vector2f.add(pos, self.offset):addInts(widget.x, widget.y);
    local wself = (((xp.x >= widget.x) and (xp.y >= widget.y)) and (xp.x <= (widget.x + widget.width))) and (xp.y <= (widget.x + widget.width));
    widget:onClickUp(xp2, xp, mb, wself);
    if (widget.requestsRerender) then 
      self:requestRerender();
    end;
  end;
end
SimpleContainer.prototype.onScroll = function(self,pos,dir,_self) 
  local _g = 0;
  local _g1 = self.children;
  while (_g < _g1.length) do _hx_do_first_1 = false;
...
Label.prototype.renderImpl = function(self,screenwidth,screenheight,width,height) 
  ...
  while (_g < _g1) do _hx_do_first_1 = false;
    ...
    if (char == "\n") then 
      ...
      o:push(PositionedRenderCommand.new(cposx, cposy, char, self.style.fgColor, self.style.bgColor));
      cposx = cposx + 1;
    end;
  end;
  do return o end
...
Main2.__name__ = true
Main2.main = function() 
  local amogid = __typedefs_Simpleterminal.new(function(s) 
    _G.io.write(Std.string(s));
    _G.io.flush();
  end);
  local nxterm = nil;
  nxterm = term;
  local term = __typedefs_CCTerminal.new(nxterm);
  local screen = Label.new(1, 1, "No screens!");
  local r = Runner.new(term, screen);
  r.root = ScreenManager.fromJSON(term, ___Main2_Main2_Fields_.sdata);
  r:run();
end

___Main2_Main2_Fields_.new = {}
___Main2_Main2_Fields_.__name__ = true
...
RenderCommand.new = function(char,fgColor,bgColor) 
  local self = _hx_new(RenderCommand.prototype)
  RenderCommand.super(self,char,fgColor,bgColor)
  return self
end
RenderCommand.super = function(self,char,fgColor,bgColor) 
...
PositionedRenderCommand.new = function(x,y,char,fgColor,bgColor) 
  local self = _hx_new(PositionedRenderCommand.prototype)
  PositionedRenderCommand.super(self,x,y,char,fgColor,bgColor)
  return self
end
PositionedRenderCommand.super = function(self,x,y,char,fgColor,bgColor) 
  self.x = x;
  self.y = y;
  RenderCommand.super(self,char,fgColor,bgColor);
end
...
Buffer.prototype.blitBuffer = function(self,buffer,ox,oy) 
  ...
  while (_g_current < _g_array.length) do _hx_do_first_1 = false;
    ...
    while (_g_current < _g_array.length) do _hx_do_first_2 = false;
      ...
      local fixedX = ix + ox;
      local fixedY = iy + oy;
      if ((((self.matrix.length > fixedY) and (self.matrix[fixedY].length > fixedX)) and (fixedY >= 0)) and (fixedX >= 0)) then 
        self.matrix[fixedY][fixedX] = command;
      end;
    end;
  end;
end
...
Runner.prototype.run = function(self) 
  self.renderer:resize(self.term:getSize().x, self.term:getSize().y);
  self.renderer:render(self.root:current());
  while (true) do _hx_do_first_1 = false;
    
    local length = nil;
    local tab = __lua_PairTools.copy(_hx_table.pack(os.pullEvent()));
    local length = length;
    local ev;
    if (length == nil) then 
      length = _hx_table.maxn(tab);
...
__typedefs_Simpleterminal.super = function(self,pf) 
  self.apalette = _hx_tab_array({[0]=RGBColor.new(236, 239, 244), RGBColor.new(0, 0, 0), RGBColor.new(180, 142, 173), RGBColor.new(0, 0, 0), RGBColor.new(235, 203, 139), RGBColor.new(163, 190, 140), RGBColor.new(0, 0, 0), RGBColor.new(173, 179, 187), RGBColor.new(216, 222, 187), RGBColor.new(136, 192, 208), RGBColor.new(0, 0, 0), RGBColor.new(129, 161, 193), RGBColor.new(0, 0, 0), RGBColor.new(163, 190, 140), RGBColor.new(191, 97, 106), RGBColor.new(59, 66, 82)}, 16);
  __typedefs_Terminal.super(self);
...
__typedefs_CCTerminal.super = function(self,term) 
  ...
  self.termxe = term;
  local _g_current = 0;
  local _g_array = _hx_tab_array({[0]=RGBColor.new(236, 239, 244), RGBColor.new(0, 0, 0), RGBColor.new(180, 142, 173), RGBColor.new(0, 0, 0), RGBColor.new(235, 203, 139), RGBColor.new(163, 190, 140), RGBColor.new(0, 0, 0), RGBColor.new(173, 179, 187), RGBColor.new(216, 222, 187), RGBColor.new(136, 192, 208), RGBColor.new(0, 0, 0), RGBColor.new(129, 161, 193), RGBColor.new(0, 0, 0), RGBColor.new(163, 190, 140), RGBColor.new(191, 97, 106), RGBColor.new(59, 66, 82)}, 16);
  while (_g_current < _g_array.length) do _hx_do_first_1 = false;
...
__typedefs_CCTerminal.prototype.setCursorPos = function(self,x,y) 
  self.termxe.setCursorPos(x + 1, y);
end
