local _0x1EA5C8F8 = "[{\"x\":0,\"y\":0,\"xa\":0,\"ya\":0,\"vexpand\":0,\"hexpand\":0,\"width\":51,\"height\":19,\"id\":\"232258089.27383706\",\"children\":[{\"labelText\":\"left!\",\"x\":0,\"y\":0,\"xa\":0,\"ya\":0,\"vexpand\":0,\"hexpand\":0,\"width\":5,\"height\":1,\"id\":\"datelabel\",\"children\":[],\"style\":{\"fgColor\":\"0\",\"bgColor\":\"f\"},\"typeName\":\"Label\"},{\"labelText\":\"center!\",\"x\":0,\"y\":0,\"xa\":0.5,\"ya\":0,\"vexpand\":0,\"hexpand\":0,\"width\":7,\"height\":1,\"id\":\"clocklabel\",\"children\":[],\"style\":{\"fgColor\":\"d\",\"bgColor\":\"e\"},\"typeName\":\"Label\"},{\"labelText\":\"right!\",\"x\":0,\"y\":0,\"xa\":1,\"ya\":0,\"vexpand\":0,\"hexpand\":0,\"width\":6,\"height\":1,\"id\":\"rightlabel\",\"children\":[],\"style\":{\"fgColor\":\"0\",\"bgColor\":\"f\"},\"typeName\":\"Label\"},{\"placeholder\":\"Amogus\\n(in multiline)\",\"x\":10,\"y\":2,\"xa\":0,\"ya\":0,\"vexpand\":0,\"hexpand\":0,\"width\":20.902778066602764,\"height\":3.6333333333333346,\"id\":\"amoglabel\",\"children\":[],\"style\":{\"fgColor\":\"0\",\"bgColor\":\"7\"},\"typeName\":\"TextArea\"}],\"style\":{\"fgColor\":\"0\",\"bgColor\":\"f\"},\"typeName\":\"Container\"}]";-- Generated by Haxe 4.3.6
...
SimpleContainer.prototype.lsw= nil;
SimpleContainer.prototype.lsh= nil;
...
Button.prototype.onClick = function(self,pos,mb,wself) 
  Runner.log(Std.string(Std.string(Std.string(Std.string(Std.string("Position: ") .. Std.string(pos.x)) .. Std.string(", ")) .. Std.string(pos.y)) .. Std.string(" Self: ")) .. Std.string(Std.string(wself)), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/Button.hx",lineNumber=232,className="Button",methodName="onClick"}));
  if (wself) then 
...
TextArea.prototype.onClick = function(self,pos,mb,wself) 
  if (self.focused and wself) then 
    ...
    self.cursorPos.y = Math.max(pos1, tmp);
    local pos = pos.x;
    local tmp = #String.prototype.split(self.value, "\n")[Std.int(self.cursorPos.y)] - 1;
    self.cursorPos.x = Math.max(pos, tmp);
  end;
  self.focused = wself;
  self:requestRerender();
end
TextArea.prototype.onCustom = function(self,c) 
  ...
  self.cursorPos.y = Math.max(tmp, tmp1);
  local tmp = self.cursorPos.x;
  local tmp1 = #String.prototype.split(self.value, "\n")[Std.int(self.cursorPos.y)] - 1;
  self.cursorPos.x = Math.max(tmp, tmp1);
...
TextArea.prototype.onRender = function(self) 
  ...
  self:getWman().term:setCursorPos(Std.int((self:fixedX(ts.x, ts.y, false) + self.cursorPos.x) + 1), Std.int((self:fixedY(ts.x, ts.y, false) + self.cursorPos.y) + 1));
  self:getWman().term:setCursorBlink(self.focused);
end
TextArea.prototype.renderImpl = function(self,screenwidth,screenheight,width,height) 
  ...
  while (_g < _g1) do _hx_do_first_1 = false;
    ...
    if (char == "\n") then 
      ...
      o:push(PositionedRenderCommand.new(cposx, cposy, char, (function() 
        local _hx_2
        if (#self.value > 0) then 
...
Runner.super = function(self,term,root,peripheralName) 
  ...
  Runner.log("Created runner", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/UI.hx",lineNumber=45,className="Runner",methodName="new"}));
end
