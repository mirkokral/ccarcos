...
|build/config|-1|
|build/system/apis|-1|
|build/services/enabled|-1|
|build/startup.lua|0|
|build/objList.txt|9136|
|build/system/krnl.lua|10053|
|build/system/installer.lua|25264|
|build/system/liveinst.lua|29710|
|build/system/devinstaller.lua|31962|
|build/system/rel|36123|
|build/system/bootloader.lua|36129|
|build/system/apis/col.lua|37078|
|build/system/apis/rd.lua|41151|
|build/system/apis/files.lua|42155|
|build/system/apis/tutils.lua|50788|
|build/system/apis/ui.lua|51759|
|build/system/apis/arc.lua|72663|
|build/system/apis/hashing.lua|80159|
|build/services/arcfix.lua|84783|
|build/services/elevator.lua|86278|
|build/services/elevatorStep.lua|88569|
|build/services/elevatorSrv.lua|89161|
|build/services/shell.lua|92217|
|build/services/pms.lua|92247|
|build/services/oobe.lua|95827|
|build/services/enabled/9 arcfix|101572|
|build/services/enabled/login|101585|
|build/apps/shell.lua|101595|
|build/apps/cd.lua|104209|
|build/apps/ls.lua|104507|
|build/apps/mv.lua|105122|
|build/apps/cp.lua|105360|
|build/apps/cat.lua|105598|
|build/apps/rm.lua|105798|
|build/apps/mkdir.lua|105949|
|build/apps/uitest.lua|106064|
|build/apps/kmsg.lua|111389|
|build/apps/arc.lua|111438|
|build/apps/adduser.lua|114332|
|build/apps/rmuser.lua|114846|
|build/apps/init.lua|115250|
|build/config/passwd|118123|
|build/config/aboot|118373|
|build/config/arcshell|118509|
|build/config/arcrepo|118561|
--ENDTABLE
...
f.close()
os.reboot()brokenfunction mysplit(inputstr, sep)
    if sep == nil then
      sep = "%s"
    end
    local t = {}
...
endlocal mdm = devices.find("modem")
...
arcos.r({}, "/apps/shell.lua")local currentPowerUsage = 0
...
endl|arcfix.lua
o oobe.luaterm.setTextColor(col.blue)
print(arcos.version())
...
environ.workDir = plocal path = ... or environ.workDir
...
endif arcos.getCurrentTask().user ~= "root" then
...
arcos.createUser(username, password)if arcos.getCurrentTask().user ~= "root" then
    write("[escalation] Enter root password: ")
    local pass = read("*")
    local f = tasking.changeUser("root", pass)
    if not f then
...
endfor index, value in ipairs(files.ls("/services/enabled")) do
