...
class Attachment:
    _hx_class_name = "Attachment"
    __slots__ = ()
    _hx_methods = ["attach"]

    def attach(self,gss):
        _this = gss.attachments
        _this.append(self)



class EcoFriendlyWoodVeneir(Attachment):
    _hx_class_name = "EcoFriendlyWoodVeneir"
    __slots__ = ("EcoFriendlyness",)
    _hx_fields = ["EcoFriendlyness"]
    _hx_methods = []
    _hx_statics = []
    _hx_interfaces = []
    _hx_super = Attachment
...
class GalvanizedSquareSteel:
    _hx_class_name = "GalvanizedSquareSteel"
    __slots__ = ("attachments",)
    _hx_fields = ["attachments"]
...
class Test:
    ...
    @staticmethod
    def main():
        steel = GalvanizedSquareSteel()
        wood = EcoFriendlyWoodVeneir()
        wood.attach(steel)
        _hx_str = Std.string(steel.attachments)
        python_Lib.printString((("" + ("null" if _hx_str is None else _hx_str)) + HxOverrides.stringOrNull(python_Lib.lineEnd)))
        _hx_str = Std.string(sys_Http.requestUrl("https://raw.githubusercontent.com/luvit/luv/master/LICENSE.txt"))
        python_Lib.printString((("" + ("null" if _hx_str is None else _hx_str)) + HxOverrides.stringOrNull(python_Lib.lineEnd)))
