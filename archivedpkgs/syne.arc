...
Kernel.prototype.run = function(self) 
  ...
  Logger.log(Std.string("Syne ") .. Std.string("Dawn"), 1, nil, nil, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="./src/Kernel.hx",lineNumber=411,className="Kernel",methodName="run"}));
...
__syscall_extensions_ArcosExtension.prototype.getSyscalls = function(self,kernel) 
  do return _hx_tab_array({[0]=__syscall_Syscall.new("panic", function(...) 
    ...
    local d = {...}
    do return _hx_tab_array({[0]=Std.string(Std.string(Std.string("Syne") .. Std.string("Dawn")) .. Std.string(" built on Haxe ")) .. Std.string("4.306")}, 1) end;
